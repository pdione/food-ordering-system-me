...
public class OrderDataMapper {
    ...
    public Order createOrderCommandToOrder(CreateOrderCommand createOrderCommand) {
        return Order.builder()
                ...
                .items(orderItemsToOrderItemEmtities(createOrderCommand.getItems()))
                .build();
    }
    ...
    private List<OrderItem> orderItemsToOrderItemEmtities(List<com.food.ordering.system.domain.dto.create.OrderItem> orderItems) {
